          ...
          <Card className="p-8 shadow-card">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                {qualifications.map((qualification, index) => <div key={index} className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-salon-rose rounded-full flex-shrink-0 mt-2" />
                    <p className="text-muted-foreground leading-relaxed max-w-3xl">{qualification}</p>
                  </div>)}
              </div>
